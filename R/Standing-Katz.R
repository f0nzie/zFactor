...
#' @param dfile the text file with SK chart values of Ppr vs z
...
getZcurve2 <- function(dfile, tolerance = 0.01, save = TRUE) {
    ...
    if (save) {
        ...
        save(list = .tpr, file = rda_file)     # save with same name as input
    }
...
#' List all Standing-Katz curves available
#'
