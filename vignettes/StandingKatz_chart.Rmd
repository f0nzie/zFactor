...
```{r}
intersect(common$Ppr_near)
```

```{r}
unique(common$.id)
common[common$.id == "1.05", c(".id", "Ppr_near")]$Ppr_near
```

```{r}
# finding the intesected values for the three vectors
# "1.05" "1.1"  "1.2" 
intersect(intersect(common[common$.id == "1.05", c(".id", "Ppr_near")]$Ppr_near, common[common$.id == "1.1", c(".id", "Ppr_near")]$Ppr_near), common[common$.id == "1.2", c(".id", "Ppr_near")]$Ppr_near)
```

```{r}
# common values of Ppr for Tpr=1.05 and Tpr=1.1
intersect(common[common$.id == "1.05", c(".id", "Ppr_near")]$Ppr_near, common[common$.id == "1.1", c(".id", "Ppr_near")]$Ppr_near)
```

```{r}
intersect(common[common$.id == "1.1", c(".id", "Ppr_near")]$Ppr_near, common[common$.id == "1.2", c(".id", "Ppr_near")]$Ppr_near)
```

```{r}
intersect(common[common$.id == "1.05", c(".id", "Ppr_near")]$Ppr_near, common[common$.id == "1.2", c(".id", "Ppr_near")]$Ppr_near)
```
```
