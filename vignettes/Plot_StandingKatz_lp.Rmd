...
We have this other simpler function that will return only the data without saving, plotting or viewing the data object. It is called `getStandingKatzData`:
...
## Low range Tpr
If just prefer the low range Tpr curves:
