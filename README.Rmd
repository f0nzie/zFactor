...
* A correlation by Shell Oil Company (SH) `r citep(bib[c("Kumar2004")])`
* A correlation developed with Artificial Neural Networks (Ann10) by Kamyab et al. See footnotes `r citep(bib[c("Kamyab2010")], linked = TRUE)`
