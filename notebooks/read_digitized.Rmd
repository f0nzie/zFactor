...
```{r}
getZcurve2("tpr_130.txt")
```

### $T_{pr} = 1.40$

```{r}
getZcurve2("tpr_140.txt")
```

### $T_{pr} = 1.50$

```{r}
getZcurve2("tpr_150.txt")
```

### $T_{pr} = 1.70$

```{r}
getZcurve2("tpr_170.txt")
```
